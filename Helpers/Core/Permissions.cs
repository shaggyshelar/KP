...
namespace ESPL.KP.Helpers.Core
{
    public static class Permissions
    {
        ...
        public const string OccurrenceAssignmentDelete = "OA" + "." + "D";
        public const string OccurrenceAssignmentRead = "OA" + "." + "R";
        public const string OccurrenceAssignmentCreate = "OA" + "." + "C";
        public const string OccurrenceAssignmentUpdate = "OA" + "." + "U";

        public const string OccurrenceReviewDelete = "OR" + "." + "D";
